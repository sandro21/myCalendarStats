    ...
    <main className="max-w-3xl mx-auto px-8 py-12">
      ...
      <div className="text-gray-800">
        ...
        <div className="space-y-6">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-black mb-3">3. User Data & Privacy</h2>
            <p className="text-base leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-black mb-3">4. Google API Services</h2>
            <p className="text-base leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-black mb-3">5. Disclaimer</h2>
            <p className="text-base leading-relaxed">
