...
export default function PrivacyPage() {
  ...
  return (
    <main className="max-w-3xl mx-auto px-8 py-12">
      ...
      <h1 className="text-4xl font-bold text-black mb-8">Privacy Policy for MyCalendarStats</h1>
      
      <div className="space-y-6 text-gray-800">
        <section>
          <h2 className="text-2xl font-semibold text-black mb-3">1. Data Access & Collection</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-black mb-3">2. Limited Use Disclosure</h2>
          <p className="text-base leading-relaxed">
